...
import static com.batuhan.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BatuhanException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleMonolitichException(BatuhanException ex){
    ...
    /**
     * Error Messagelarınızı özel bir method içinde create edilir. Çünkü oluşan hataların
